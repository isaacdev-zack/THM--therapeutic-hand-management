...
export function PromiseSection() {
  return (
    <section className="bg-white px-5 py-14 sm:px-8 lg:px-10 lg:py-16">
      <div className="mx-auto grid max-w-[1120px] gap-8 lg:grid-cols-12 lg:gap-10 lg:items-stretch">
        <div className="flex flex-col justify-center lg:col-span-5">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              href="/about"
              className="inline-flex h-11 items-center rounded-full bg-thm-purple px-6 font-poppins text-sm font-semibold text-white hover:bg-thm-purple-dark"
            >
              About THM
            </Link>
            <Link
              href="/programs"
              className="inline-flex h-11 items-center rounded-full border border-thm-ink/20 px-6 font-poppins text-sm font-semibold text-thm-ink hover:border-thm-purple hover:text-thm-purple"
            >
              View programs
            </Link>
          </div>
        ...
        <div className="relative min-h-[280px] overflow-hidden lg:col-span-7 lg:min-h-[340px]">
          <Image
